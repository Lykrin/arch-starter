...
echo "waybar rofi wofi kitty fastfetch dunst dolphin xdg-desktop-portal-hyprland qt5-wayland qt6-wayland hyprpaper chromium ttf-font-awesome"
echo ""
...
sudo pacman -S waybar rofi wofi kitty dunst thunar xdg-desktop-portal-hyprland qt5-wayland qt6-wayland hyprpaper neovim
